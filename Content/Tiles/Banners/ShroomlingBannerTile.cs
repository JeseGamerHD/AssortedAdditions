...
{
    internal class ShroomlingBannerTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(24, 186, 222), name); // Name will be just Banner like the vanilla ones (set in localisation)
        }
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            if (closer)
            {
                int type = ModContent.NPCType<NPCs.Shroomling>();
