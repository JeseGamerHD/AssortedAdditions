...
{
    internal class FrostWraithBannerTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(29, 202, 173), name); // Name will be just Banner like the vanilla ones (set in localisation)
        }
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            if (closer)
            {
                int type = ModContent.NPCType<NPCs.FrostWraith>();
