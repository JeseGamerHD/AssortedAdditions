...
internal class ShadowConcoctionProj : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        if (Main.rand.NextBool(15)) // Chance to spawn dust when in the air
        {
            Dust dust = Dust.NewDustDirect(Projectile.position - Projectile.velocity, Projectile.width, Projectile.height,
                    DustID.Shadowflame, 0, 0, 100, Color.LightPink, 3f);
    ...
    public override void Kill(int timeLeft)
    {
        ...
        for (int i = 0; i < 30; i++)
        {
            ...
            Dust dust = Dust.NewDustPerfect(Projectile.Center, DustID.Shadowflame, speed * 4, Scale: 2f);
            dust.noGravity = false;
