...
// This is a copy of the Excalibur's projectile (from ExampleMod)
public class AuroraBladeProj : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
        {
            ...
            Dust.NewDustPerfect(dustPosition, 15, dustVelocity, 100, Color.SkyBlue * Projectile.Opacity, 1.2f * Projectile.Opacity);
        }
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Color backDarkColor = new Color(12, 212, 108); // Original Excalibur color: Color(180, 160, 60)
        Color middleMediumColor = new Color(12, 212, 196); // Original Excalibur color: Color(255, 255, 80)
        Color frontLightColor = new Color(14, 52, 189); // Original Excalibur color: Color(255, 240, 150)
