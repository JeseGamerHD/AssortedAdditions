...
namespace AssortedAdditions.Content.Projectiles.MeleeProj
{
    ...
    // Also tested out how documenting stuff so it shows up when hovering works

    /// <summary>
    /// A Base class for creating swing effects similar to Excalibur or The Horseman's Blade.
    /// </summary>
    /// <remarks>
    /// You can customize the swing effect by setting these in SetDefaults():
    /// <list type="Attributes">
    /// <item>ScaleMultiplier: float</item>
    /// <item>ScaleAdderValue: float</item>
    /// <item>PrimaryDustColor: Color</item>
    /// <item>SecondaryDustColor: Color</item>
    /// <item>DustType: DustID.dustName or int</item>
    /// <item>DoHitEffect: bool, whether or not to spawn particles when hitting nps/players</item>
    /// <item>HitEffect: ParticleOrchestraType.name</item>
    /// <item>SwingBackColor: Color</item>
    /// <item>SwingMiddleColor: Color</item>
    /// <item>SwingFrontColor: Color</item>
    /// </list>
    /// </remarks>
    public abstract class SwingTrailBase : ModProjectile
    {
        // For AI()
        /// <summary>
        /// Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
        /// </summary>
        public float ScaleMultiplier { get; set; } = 0.2f;

        /// <summary>
        /// Excalibur, Terra Blade, and The Horseman's Blade is 1f; True Excalibur is 1.2f; default is 1f 
        /// </summary>
        public float ScaleAdderValue { get; set; } = 1f;

        /// <summary>
        /// Primary color for the dust which spawns when swinging
        /// </summary>
        public Color PrimaryDustColor { get; set; } = Color.White;

        /// <summary>
        /// Secondary color for the dust which spawns when swinging
        /// </summary>
        public Color SecondaryDustColor { get; set; } = Color.White;

        /// <summary>
        /// The Dust which spawns when swinging
        /// </summary>
        public int DustType { get; set; } = DustID.TintablePaint;

        // For OnHitNPC and OnHitPlayer
        /// <summary>
        /// Whether or not to do a ParticleOrchestraType effect when hitting an NPC or a Player
        /// </summary>
        public bool DoHitEffect { get; set; } = false;

        /// <summary>
        /// The ParticleOrchestraType which spawns when hitting NPCs or Players
        /// </summary>
        public ParticleOrchestraType HitEffect { get; set; }

        // For PreDraw()
        /// <summary>
        /// Color of the back of the swing effect
        /// </summary>
        public Color SwingBackColor { get; set; } = Color.White;

        /// <summary>
        /// Color of the middle of the swing effect
        /// </summary>
        public Color SwingMiddleColor { get; set; } = Color.White;

        /// <summary>
        /// Color of the front of the swing effect
        /// </summary>
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = SwingBackColor; // Original Excalibur color: Color(180, 160, 60)
            Color middleMediumColor = SwingMiddleColor; // Original Excalibur color: Color(255, 255, 80)
            Color frontLightColor = SwingFrontColor; // Original Excalibur color: Color(255, 240, 150)
