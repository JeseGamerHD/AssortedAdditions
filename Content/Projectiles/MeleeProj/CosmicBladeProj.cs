...
{
    internal class CosmicBladeProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float scaleMulti = 0.3f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
            float scaleAdder = 0.9f; // Excalibur, Terra Blade, and The Horseman's Blade is 1f; True Excalibur is 1.2f; default is 1f 
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
            {
                ...
                Dust coloredDust = Dust.NewDustPerfect(Projectile.Center + dustRotation.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), 15, dustVelocity * 1f, 100, dustColor, 0.4f);
            ...
            if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
            {
                ...
                Dust.NewDustPerfect(dustPosition, 15, dustVelocity, 100, Color.HotPink * Projectile.Opacity, 1.2f * Projectile.Opacity);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color backDarkColor = new Color(159, 5, 255); // Original Excalibur color: Color(180, 160, 60)
            Color middleMediumColor = new Color(134, 5, 255); // Original Excalibur color: Color(255, 255, 80)
            Color frontLightColor = new Color(109, 5, 255); // Original Excalibur color: Color(255, 240, 150)
